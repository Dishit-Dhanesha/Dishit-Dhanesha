    ...
    <div class="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark">
      ...
      <div class="mt-6">
        ...
        <p class="mt-2 text-muted dark:text-light/70">
          ...
          of Experiences with multiple technologies. I am versatile with
          multiple technologies and continuously seek to learn and innovate.
        </p>
        ...
        <div class="mt-8 flex flex-wrap items-center gap-2">
          ...
          <UTooltip text="Download Resume">
            <a
              ...
              variant="solid"
              href="/resume.pdf"
              download="Dishit-Dhanesha-resume.pdf"
              class="flex hover:motion-preset-bounce h-10 w-20 items-center justify-center rounded-lg border border-slate-200 text-center text-white transition focus:outline-none focus:ring disabled:pointer-events-none disabled:opacity-50 dark:border-transparent dark:bg-[#4BB543] dark:text-white dark:hover:text-white bg-[#4BB543]"
            >
              <UIcon
