  ...
  <div>
    <main class="grid grid-cols-1 gap-4 lg:grid-cols-3 lg:gap-6">
      ...
      <div class="grid grid-cols-1 gap-4 lg:gap-6">
        <!-- Work Experience -->
        <div
          class="group rounded-2xl bg-white px-6 pt-0 shadow dark:bg-black dark:shadow-dark"
        >
          <h3
            class="relative z-10 bg-white pb-2 pt-6 text-2xl font-semibold dark:bg-black dark:text-light"
          >
            Work Experience
          </h3>
          ...
          >
            ...
            >
              <div class="flex flex-col gap-1 md:flex-row md:gap-10">
                <p
                  class="mt-1 text-sm font-medium text-muted dark:text-light/70"
                >
                  2021 - 2023
                </p>
                <div class="flex items-center gap-3">
                  ...
                  <div class="">
                    ...
                    <p class="text-sm text-muted">Senior Product Designer</p>
                  </div>
                </div>
              </div>
              <div class="flex flex-col gap-1 md:flex-row md:gap-10">
        ...
        <!-- Expertise -->
        <div
          class="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark"
        >
          ...
          <div class="mt-6 grid grid-cols-2 gap-4 md:grid-cols-3">
            <div class="text-center">
              ...
              <p
                class="mt-1 text-base font-medium text-dark dark:text-light/70"
              >
                Figma
              </p>
            </div>
      ...
      <!-- Services -->
      <div
        class="rounded-2xl bg-white p-6 shadow dark:bg-black dark:shadow-dark lg:col-span-2"
      >
        <div class="flex flex-wrap items-center justify-between gap-2">
          <h3 class="text-2xl font-semibold dark:text-light">
            Services I Offered
      ...
      >
        ...
        <h2
          class="mt-4 text-[40px] font-semibold leading-snug text-dark dark:text-light"
        >
          Let's👋 <br />
          Work Together
        </h2>
